...
public class Main extends GLScreen {
    ...
    public Main(GLGame game) {
        ...
        w.setPosition(20, Gui.HEIGHT - 29);
        widgets.add(w);
    ...
    private class GameOptionsButton extends Button {
        ...
        GameOptionsButton() {
            setGeometry(Gui.WIDTH / 2 - 45 - 350, 270, 350, 36);
    ...
    private class MatchOptionsButton extends Button {
        ...
        MatchOptionsButton() {
            setColor(0x3847A3);
            setGeometry(Gui.WIDTH / 2 - 45 - 350, 315, 350, 36);
    ...
    private class ControlsButton extends Button {
        ...
        ControlsButton() {
            setColor(0x83079C);
            setGeometry(Gui.WIDTH / 2 - 45 - 350, 360, 350, 36);
    ...
    private class EditTacticsButton extends Button {
        ...
        EditTacticsButton() {
            setColor(0xBA9206);
            setGeometry(Gui.WIDTH / 2 - 45 - 350, 405, 350, 36);
    ...
    private class EditTeamsButton extends Button {
        ...
        EditTeamsButton() {
            ...
            setGeometry(Gui.WIDTH / 2 - 45 - 350, 450, 350, 36);
    ...
    private class FriendlyButton extends Button {
        ...
        FriendlyButton() {
            setGeometry(Gui.WIDTH / 2 + 45, 270, 350, 36);
    ...
    private class DiyCompetitionButton extends Button {
        ...
        DiyCompetitionButton() {
            ...
            setGeometry(Gui.WIDTH / 2 + 45, 315, 350, 36);
    ...
    private class PresetCompetitionButton extends Button {
        ...
        PresetCompetitionButton() {
            ...
            setGeometry(Gui.WIDTH / 2 + 45, 360, 350, 36);
    ...
    private class TrainingButton extends Button {
        ...
        TrainingButton() {
            ...
            setGeometry(Gui.WIDTH / 2 + 45, 405, 350, 36);
    ...
    private class OnlineMatchButton extends Button {
        ...
        OnlineMatchButton() {
            setColor(0x1A5581);
            setGeometry(Gui.WIDTH / 2 + 45, 450, 350, 36);
    ...
    private class ReplayContinueCompetitionButton extends Button {
        ...
        ReplayContinueCompetitionButton(int y) {
            ...
            setGeometry((Gui.WIDTH - 600) / 2, y, 600, 32);
    ...
    private class SaveCompetitionButton extends Button {
        ...
        SaveCompetitionButton(int y) {
            ...
            setGeometry((Gui.WIDTH - 600) / 2, y + 40, 600, 32);
    ...
    private static class MusicButton extends Button {

        MusicButton() {
            setGeometry(0, Gui.HEIGHT - 20, 360, 20);
            setText("", LEFT, font10);
        }
    ...
    private class DeveloperToolsButton extends Button {
        ...
        DeveloperToolsButton() {
            setColor(0x191FB0);
            setGeometry((Gui.WIDTH - 300) / 2, 675, 300, 32);
